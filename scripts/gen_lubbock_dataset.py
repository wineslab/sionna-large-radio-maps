#!/usr/bin/env python3
"""
Lubbock, TX Coverage Map Dataset Generator

Flat rural area - generates path gain and elevation maps by dynamically 
...
# Lubbock, TX bounds (flat rural area)
CITY_NAME = "lubbock"
CITY_LAT = (33.50, 33.62)
CITY_LON = (-101.92, -101.78)
...
MAX_ELEVATION_RANGE = 100   # Flat terrain - strict limit on elevation range
    ...
    try:
        ...
        with h5py.File(output_file, 'w') as f:
            f.attrs.update(center_lat=lat, center_lon=lon, radius=radius, frequency=FREQUENCY,
                          ...
                          city=CITY_NAME, terrain_type="flat_rural")
...
def main():
    ...
    print("=" * 60)
    print(f"Terrain type: Flat Rural")
