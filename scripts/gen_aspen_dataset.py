#!/usr/bin/env python3
"""
Aspen, CO Coverage Map Dataset Generator

Rural mountain area - generates path gain and elevation maps by dynamically 
...
# Aspen, CO bounds (rural mountain area)
CITY_NAME = "aspen"
CITY_LAT = (39.16, 39.22)
CITY_LON = (-106.86, -106.78)
...
def generate_sample(args):
    ...
    try:
        ...
        # Check minimum buildings (allow 0 for rural)
...
def main():
    ...
    print("=" * 60)
    print(f"Terrain type: Rural Mountain")
